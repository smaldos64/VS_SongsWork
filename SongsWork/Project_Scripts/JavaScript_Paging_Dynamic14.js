...
function AddPageComponentsDynamic(PagingComponentsClassFunc, ObjectArgument) {
    ...
    if (null == PagingComponentClass.data('PagerIndexCounter')) {
        CurrentPagerIndexCounter = PagerIndexCounter;
        PagingComponentClass.data('PagerIndexCounter', PagerIndexCounter);
    }
    else {
        CurrentPagerIndexCounter = PagingComponentClass.data('PagerIndexCounter');
    }
    
    if (null == ObjectArgument.PagerStyleName) {
        PagerStyleName = "Current_Highlight";
    }
    else {
        PagerStyleName = ObjectArgument.PagerStyleName;
    }
    ...
    if (Number_Of_Elements_In_Slider > 0) {
        ...
        //WorkStringSelect += '<select name="' + SelectPagerName + CurrentPagerIndexCounter + '" id="' + SelectPagerName + CurrentPagerIndexCounter + '" class="pagingElementsOnSide">';
        WorkStringSelect += '<select name="' + SelectPagerName + CurrentPagerIndexCounter + '" id="' + SelectPagerName + CurrentPagerIndexCounter + '" class="pagingElementsOnSide' + CurrentPagerIndexCounter + '">';
        ...
        if (null == PagingElementBefore) {
            //Hvis ikke Pager klasserne ligger inde i en tabel, så sæt antal elementer pr. side selektoren ind
            ...
            //Hvis Pager klasserne ligger inde i en tabel, så sæt antal elementer pr. side selektoren ind
            //før tabellen.
        ...
        PagingClassSelect.data('PagerStyleName', PagerStyleName);
        ...
        var ChangePagerElementsOnSide = $('".pagingElementsOnSide' + CurrentPagerIndexCounter + '"').on('change', function (e) {
            e.preventDefault();
        ...
        WorkString += '<nav name="' + NavigationPagerName + CurrentPagerIndexCounter + '" id="' + NavigationPagerName + CurrentPagerIndexCounter + '" class="paging_init">';
...
function ChangePagerElementsOnSideOnPager($this) {
    ...
    if (null == $this.data('PagerClassName')) {
        $$this = $this.parent();
    }
    else {
        $$this = $this;
    ...
    AddPageComponentsDynamic($$this.data('Paging_Component_Class'),
        {
            ...
            PagerStyleName: $$this.data('PagerStyleName')
        }
    );
}
